...
pub struct Deployment {
    ...
    pub spec: Option<crate::api::apps::v1beta1::DeploymentSpec>,

    /// Most recently observed status of the Deployment.
    pub status: Option<crate::api::apps::v1beta1::DeploymentStatus>,
}
...
impl Deployment {
    ...
    pub fn create_namespaced_deployment(
        namespace: &str,
        body: &crate::api::apps::v1beta1::Deployment,
...
pub enum ReadNamespacedDeploymentResponse {
    Ok(crate::api::apps::v1beta1::Deployment),
...
impl crate::Resource for Deployment {
    ...
    const PLURAL_NAME: Option<&'static str> = Some("deployments");
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: crate::serde::Deserializer<'de> {
        ...
        impl<'de> crate::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: crate::serde::de::MapAccess<'de> {
                ...
                let mut value_spec: Option<crate::api::apps::v1beta1::DeploymentSpec> = None;
                let mut value_status: Option<crate::api::apps::v1beta1::DeploymentStatus> = None;
